...
public class C04_Faktoryel {
    public static void main(String[] args) {
        ...
        if(input>=0 && input<15){
            ...
            System.out.println("girilen sayi 15'den kucuk pozitif sayi olmalidir");
        }
    ...
    public static void faktoryelYazdir(int sayi){
      ...
      int faktorYelsonucu=1;
        for (int i = sayi; i >=1 ; i--) {
            ...
            faktorYelsonucu= faktorYelsonucu*i;// her loop'da gelen sayiyi onceki deger ile carpalim



        }

        System.out.println("girilen "+ sayi+ " icin faktöryel: "+ faktorYelsonucu  );
