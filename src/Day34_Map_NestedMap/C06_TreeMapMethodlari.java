...
public class C06_TreeMapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfSayilariMap.subMap("C", "K"));//{C=15, D=3} Cdahil ,  k haric
        ...
        System.out.println(harfSayilariMap.headMap("D"));//{A=10, C=15} "D" ye kadar anlaminda d dahil ddegil.
        ...
        System.out.println(harfSayilariMap.ceilingKey("C"));
