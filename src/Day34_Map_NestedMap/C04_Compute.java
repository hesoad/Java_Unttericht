...
public class C04_Compute {
    public static void main(String[] args) {
        ...
        // 2.yontem compute
        Map<String,Integer>harfSayialri2=new TreeMap<>();
        for (int i = 0; i <arr.length ; i++) {


        harfSayialri2.computeIfPresent(arr[i],(k,v)->v+1);
        harfSayialri2.computeIfAbsent(arr[i],v->1);

        }
        System.out.println(harfSayialri2);
