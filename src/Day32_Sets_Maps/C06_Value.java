...
public class C06_Value {
    public static void main(String[] args) {
        ...
        System.out.println(ogrenciMap.values());//[Ali-Can-11-H-MF, Veli-Cem-10-K-M, Ali-Cem-11-k-TM, Ayse-Can-10-H-MF, Sevgi-Cem-10-H-MF, Sevgi-Can-10-H-MF, Cemal-Han-12-M-MF]

        // verilen ismin ogrenciMap de olup olmadigini kontrol edip
        //treu veya false donen bir method olusturun
        boolean sonuc= MapMethodDepo.isimIleOgrenciArama(ogrenciMap,"Ali");

        System.out.println(sonuc); // true
        System.out.println(MapMethodDepo.isimIleOgrenciArama(ogrenciMap, "Veli"));//true
