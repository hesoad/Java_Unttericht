...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb.capacity());// 20; 16+4=20
        System.out.println(sb.length());//4

        sb.trimToSize();
        //Atama yapmadigimiz halde bu degisiklik kalici olur,
        // StringBuilder mutable oldugu icin metotlara yapilan degisiklikler kalici olur .
