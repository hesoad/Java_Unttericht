...
public class C07_substring {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str.substring(0, 15));//Java ogren, isi
        ...
        System.out.println(str.toUpperCase().substring(str.length() - 3));//KAP

        // substring kullanarak sadece J harfini yazdirin
        System.out.println(str.toLowerCase().substring(0, 1));//j
       ...
       // System.out.println(str.charAt(str.substring()));
